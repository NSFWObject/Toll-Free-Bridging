...
- (void)testAdddingObjectsInCorrectOrder {
    ...
    [self.heap addObject:minusTwo];
    XCTAssertEqualObjects(self.heap.minimumObject, minusTwo);
}
...
- (void)testRemovingMinimumObject {
    ...
    XCTAssertEqualObjects(self.heap.minimumObject, ten);
}
...
- (void)testCountBridging {
    XCTAssertEqual(CFBinaryHeapGetCount((__bridge CFBinaryHeapRef)self.heap), ((BinaryHeap *)self.cfHeap).count);
}
...
- (void)testGetMinimumBridging {
    XCTAssertEqualObjects((__bridge id)CFBinaryHeapGetMinimum((__bridge CFBinaryHeapRef)self.heap),
                          ((BinaryHeap *)self.cfHeap).minimumObject);
...
- (void)testAddValueBridging {
    ...
    XCTAssertEqualObjects(self.heap.minimumObject, newMinimum);
...
- (void)testRemoveMinimumBridging {
    ...
    XCTAssertEqualObjects(self.heap.minimumObject, twenty);
